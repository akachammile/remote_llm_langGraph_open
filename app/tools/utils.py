...
from typing import Awaitable, Callable, List, Dict, Generator
...
# def get_Embeddings(embed_model: str = None,local_wrap: bool = False) -> Embeddings:
...
def thread_pool_executor(
    ...
    Args:
        ...
        params (List[Dict], optional): 附带的参数. Defaults to [].

    Yields:
        Generator: 生成器, 生成一个处理一个
    """
    tasks = []
