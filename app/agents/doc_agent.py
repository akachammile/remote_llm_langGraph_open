...
class DocAgent(BaseAgent):
    ...
    def build_subgraph(self):
        ...
        doc_subgraph.add_node("doc_agent_supervisor", self.doc_agent_supervisor)
        doc_subgraph.add_edge(START, "doc_agent_supervisor")
        doc_subgraph.add_edge("doc_agent_supervisor", END) 
